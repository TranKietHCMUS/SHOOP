  ...
  return (
    <section className="py-16 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Curved Arrow Pointing to First Icon */}
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <motion.div
                  ...
                  className="w-16 h-16 md:w-20 md:h-20 rounded-2xl flex items-center justify-center text-white text-3xl mb-4 shadow-lg cursor-pointer"
                ...
                {index < steps.length - 1 && (
                  <div className="h-16 w-1 bg-gray-800 my-2 md:hidden flex items-center justify-center">
                ...
                {/* Content */}
                <motion.div 
                  className={`bg-white p-3 md:p-4 rounded-lg shadow-md w-full text-center ${index % 2 === 0 ? 'md:mt-16' : 'md:mb-16'}`}
                  whileHover={{ 
                    boxShadow: "0 10px 25px rgba(0,0,0,0.1)",
                    y: -5
                  }}
                >
                  <h3 className="font-bold text-base md:text-md mb-1 md:mb-2" style={{ color: step.color }}>{step.title}</h3>
